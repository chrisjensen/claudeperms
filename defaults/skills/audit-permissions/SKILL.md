...
Flag findings across five avenues:
...
2. **Guardrails disabled** — `defaultMode: bypassPermissions`/`acceptEdits`, PreToolUse hook not wired to claude-perms, empty `inline-exec-patterns`, trash disabled
